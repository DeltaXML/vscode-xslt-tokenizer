...
import { xpath40Data } from './xpath40FunctionDetails';
...
export class XPathFunctionDetails {
	...
	public static xpathData: FunctionCompletionData[] = [
		...
		{name: "xs:NMTOKENS" , signature: "xs:NMTOKENS( $arg as xs:anyAtomicType? ) as xs:NMTOKENS?" , description: "Consctuctor function."},
		...
		{name: "xs:IDREFS" , signature: "xs:IDREFS( $arg as xs:anyAtomicType? ) as xs:IDREFS?" , description: "Consctuctor function."},
		{name: "xs:ENTITY" , signature: "xs:ENTITY( $arg as xs:anyAtomicType? ) as xs:ENTITY?" , description: "Consctuctor function."},
		{name: "xs:ENTITIES" , signature: "xs:ENTITIES( $arg as xs:anyAtomicType? ) as xs:ENTITIES?" , description: "Consctuctor function."},
