...
<!-- XPath 4.0 item types: choice, enumeration, record and named item types, and fn(...) function types - errors in XPath 3.1 (keep test expressions in sync with xpItemTypesSel31.xsl) -->
