...
<!-- XPath 4.0 function syntax: fn and focus inline functions, keyword arguments, and namespace declarations - errors in XPath 3.1 (keep test expressions in sync with xpFunctionSyntax40.xsl) -->
