...
<!-- XPath 4.0 axes following-or-self, following-sibling-or-self, preceding-or-self and preceding-sibling-or-self are errors in XPath 3.1 (keep test expressions in sync with xpAxes40.xsl) -->
